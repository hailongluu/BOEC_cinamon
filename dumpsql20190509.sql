...
INSERT INTO `account` VALUES (1,'admin','admin'),(2,'halo','123456'),(3,'halo1','123456'),(4,'hailongluu','123');
...
INSERT INTO `address` VALUES (1,'Giai Phong','123','1'),(3,'Dinh cong ha hoang mai','30','1'),(4,'Dinh cong ha hoang mai','30','1'),(5,'hanoi',NULL,'1');
...
INSERT INTO `book` VALUES (1,'Nghĩ Giàu Và Làm Giàu','2018-02-02',66000,400,'Novel','Napoleon Hill','1','/img/books/vnbook/1.jpg',NULL),(2,'The Alchemist - Nhà Giả Kim','2018-11-18',158000,192,'Novel','HarperCollins UK','1','/img/books/vnbook/2.jpg',NULL),(3,' Đắc Nhân Tâm ','2018-11-18',40389,320,'Novel','Dale Carnegie','1','/img/books/vnbook/3.jpg',NULL),(4,' Tony Buổi Sáng','2018-11-18',51585,308,'Novel','Tony Buổi Sáng','1','/img/books/vnbook/4.jpg',NULL);
...
CREATE TABLE `cart` (
  ...
  PRIMARY KEY (`Id`),
  KEY `customer id_idx` (`customerId`)
...
INSERT INTO `cart` VALUES (1,1,NULL),(2,1,NULL);
...
--
-- Table structure for table `clother`
--

DROP TABLE IF EXISTS `clother`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
...
--
-- Dumping data for table `clother`
--
...
INSERT INTO `customer` VALUES (1,1,1,1,NULL,NULL,NULL),(3,4,4,3,NULL,NULL,NULL),(4,5,5,4,NULL,NULL,NULL);
...
INSERT INTO `fullname` VALUES (1,'Nguyen','Van','A'),(2,'Nguyen','Van ','B'),(3,'Hoang','Van','B'),(4,'Hoang','Van','B'),(5,'Long',NULL,'LÆ°u');
...
CREATE TABLE `order` (
  ...
  `deliverySate` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
INSERT INTO `order` VALUES (2,'1','2018-10-10','1',1,1,NULL),(3,'1','2018-11-18','1',1,1,NULL),(4,'1','2018-11-18','1',1,1,NULL),(5,'1','2018-11-18','1',1,1,NULL),(6,'1','2018-11-18','1',1,1,NULL);
