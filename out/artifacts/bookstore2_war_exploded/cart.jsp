...
<nav class="navbar navbar-default navbar-fixed-top navbar-inverse" style="width:100%">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/home" style="padding: 1px;"><img class="img-responsive" alt="Brand"
                                                                                 src="img/logo.jpg"
        ...
        <ul class="nav navbar-nav navbar-right">
            <li><a href="cart.jsp" class="btn btn-md"><span class="glyphicon glyphicon-shopping-cart">Cart</span></a>
            </li>
            <li><a href="destroy.jsp" class="btn btn-md"> <span class="glyphicon glyphicon-log-out">LogOut</span></a>
            </li>
        </ul>
    </div><!-- /.container-fluid -->
</nav>
<div id="top">
    ...
    <div class="row">
        <div class="col-xs-8 offset-xs-2  col-sm-4 offset-sm-2 col-md-4 offset-md-3 col-lg-4 offset-lg-3">
            <a href="/home" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;">Continue
                Shopping</a>
        </div>
        <div class="col-xs-6 offset-xs-3 col-sm-4 offset-sm-2 col-md-4 offset-md-1 col-lg-4 ">
            <a class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;margin-top:5px;"
